...
import TablesExample from "./BootstrapTables";
import ListsExample from "./BootstrapLists";
import FormsExample from "./BootstrapForms";
import TabsAndCardsExample from "./BootstrapNavigation";
...
export default function Lab2() {
  return (
    <Container id="wd-lab2">
      ...
      <p>
        The style attribute allows configuring look and feel right on the
        element. Although it is very convenient, it is considered bad practice
