  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-French-Toast">
          <li>Break two eggs into a bowl.</li>
          <li>Beat the eggs and add salt and pepper.</li>
          <li>Add milk and honey/cinnamon for the sweet taste.</li>
          <li>Take as many bread pieces as needed.</li>
          <li>Dip the bread and soak it into the egg mixture.</li>
          <li>Put the soaked bread on a hot pan.</li>
          <li>Flip and cook the other side.</li>
          <li>Serve and enjoy!</li>
        </ol>
      ...
      <div id="wd-tables">
        ...
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td>Q10</td>
              <td>Integration of Web App with Database</td>
              <td>3/24/21</td>
              <td>90</td>
            </tr>
          </tbody>
      ...
      <input
        type="email"
        placeholder="meghanaranitha@gmail.com"
      ...
      <input type="date" defaultValue="2003-08-21" id="wd-text-fields-dob" />
      <br />
      <h4>Anchor tag</h4>
      Please
      ...
      <h4>Anchor tag</h4>
      Please
      <a href="https://github.com/meghana2108" id="wd-github">
        click here
      </a>
      to get to my Github Profile
      <br />
    </div>
  );
}
