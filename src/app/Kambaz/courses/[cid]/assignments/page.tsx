            ...
            <div id="wd-assignments-list">
                <ul>
                    <li className="wd-assignment-list-item">
                        <Link href="/kambaz/courses/cs101/assignments/1" className="wd-assignment-link">A1 - ENV+HTML</Link>
                        <p>Due 22 Sep at 23:59 | -/100 pts</p>
                    </li>
                    <li className="wd-assignment-list-item">
                        <Link href="/kambaz/courses/cs101/assignments/2" className="wd-assignment-link">A2 - CSS+BOOTSTRAP</Link>
                        <p>Due 06 Oct at 23:59 | -/100 pts</p>
                    </li>
                    <li className="wd-assignment-list-item">
                        <Link href="/kambaz/courses/cs101/assignments/3" className="wd-assignment-link">A3 - JS+REACT</Link>
