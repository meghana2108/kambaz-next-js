...
export default function Home() {
    ...
    return (
                <Nav variant="pills">
                    ...
                    <NavItem>
                        <NavLink href="/Labs/lab1" as={Link}className={`nav-link ${pathname.endsWith("Lab1") ? "active" : " "}`}>Lab1</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink href="/Labs/lab2" as={Link}className={`nav-link ${pathname.endsWith("Lab2") ? "active" : " "}`}>Lab2</NavLink>
                    </NavItem>
                    <NavItem>
                    ...
                    <NavItem>
                        <NavLink href="/Labs/lab5" as={Link}className={`nav-link ${pathname.endsWith("Lab5")? "active": " "}`}>Lab5</NavLink>
                    </NavItem>
                    <NavItem>
